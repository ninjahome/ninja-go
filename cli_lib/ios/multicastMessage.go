...
func (i IosAPP) multicastMsg(to []string, msg *pbs.WSCryptoGroupMsg) error {
...
func (i IosAPP) multicastChatMsg(from string, msg *multicast.ChatMesageDesc, ts int64) error {
