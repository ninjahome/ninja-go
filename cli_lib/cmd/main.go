...
func main() {
	...
	serAddr := []string{"202.182.101.145:6666", "127.0.0.1:6666"} //127.0.0.1:6666//167.179.78.33
	...
	c, err := client.NewContactCli("http://167.179.78.33:6667", key) //202.182.101.145//198.13.44.159
	if err != nil {
		panic(err)
	}
