...
const (
	StreamMType_MTOnlineSync  StreamMType = 0
	StreamMType_MTOnlineAck   StreamMType = 1
...
func (x *StreamMsg) GetMTyp() StreamMType {
	...
	return StreamMType_MTOnlineSync
}
...
type StreamMsg_OnlineAck struct {
	OnlineAck *OnlineMap `protobuf:"bytes,2,opt,name=onlineAck,proto3,oneof"`
}
...
var file_stream_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf1, 0x01, 0x0a, 0x09, 0x53, 0x74,
	...
	,
	...
	0x65, 0x61, 0x6d, 0x4d, 0x54, 0x79, 0x70, 0x65, 0x12, 0x10, 0x0a, 0x0c, 0x4d, 0x54, 0x4f, 0x6e,
	0x6c, 0x69, 0x6e, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x10, 0x00, 0x12, 0x0f, 0x0a, 0x0b, 0x4d, 0x54,
	0x4f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x41, 0x63, 0x6b, 0x10, 0x01, 0x12, 0x11, 0x0a, 0x0d, 0x4d,
...
var file_stream_proto_goTypes = []interface{}{
	...
	(*OnlineMap)(nil),           // 2: pbs.stream.OnlineMap
	(*ContactSync)(nil),         // 3: pbs.stream.ContactSync
	(*ContactAck)(nil),          // 4: pbs.stream.ContactAck
	(*contact.ContactItem)(nil), // 5: pbs.contact.ContactItem
}
var file_stream_proto_depIdxs = []int32{
	0, // 0: pbs.stream.StreamMsg.MTyp:type_name -> pbs.stream.StreamMType
	2, // 1: pbs.stream.StreamMsg.onlineAck:type_name -> pbs.stream.OnlineMap
	3, // 2: pbs.stream.StreamMsg.contactSync:type_name -> pbs.stream.ContactSync
	4, // 3: pbs.stream.StreamMsg.contactAck:type_name -> pbs.stream.ContactAck
	5, // 4: pbs.stream.ContactAck.contacts:type_name -> pbs.contact.ContactItem
